...
- Brand applications in both regions are plain messages: no operator buttons and no archiving. Spectre retains its separate operator workflow. Startup removes old stored brand keyboards without deleting their messages.
